...
const float XYDChatInitialProgressValue = 0.1f;
const float XYDChatInteractiveProgressValue = 0.5f;
const float XYDChatFinalProgressValue = 0.9f;

@implementation XYDWebViewProgress {
...
- (void)startProgress
{
    if (_progress < XYDChatInitialProgressValue) {
        [self setProgress:XYDChatInitialProgressValue];
    }
}
...
- (void)incrementProgress
{
    ...
    float maxProgress = _interactive ? XYDChatFinalProgressValue : XYDChatInteractiveProgressValue;
