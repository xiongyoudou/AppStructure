...
/**
 * The `XYDChatWebViewController` class is a view controller that displays the contents of a URL
 ...
 */
@interface XYDWebViewController : UIViewController<UIWebViewDelegate>
