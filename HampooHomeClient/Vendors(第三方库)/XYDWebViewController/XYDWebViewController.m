...
#import "XYDWebViewProgress.h"
#import "XYDWebViewProgressView.h"

@interface XYDWebViewController ()<XYDWebViewProgressDelegate>
...
@property (nonatomic, strong) XYDWebViewProgress *progressProxy;
@property (nonatomic, strong) XYDWebViewProgressView *progressView;

@property (assign, nonatomic) BOOL toolbarPreviouslyHidden;

@end

@implementation XYDWebViewController
...
- (void)viewDidLoad {
    [super viewDidLoad];
    _progressProxy = [[XYDWebViewProgress alloc] init];
    ...
    _progressView = [[XYDWebViewProgressView alloc] initWithFrame:barFrame];
