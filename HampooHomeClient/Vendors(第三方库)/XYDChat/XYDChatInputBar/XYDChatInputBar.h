...
static CGFloat const kChatBarMaxHeight = kTextViewFrameMaxHeight + 2*kOffsetFromTextVToBarBottom; //114.0f;
static CGFloat const kChatBarMinHeight = kTextViewFrameMinHeight + 2*kOffsetFromTextVToBarBottom; //49.0f;
