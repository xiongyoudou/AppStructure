...
//  Get the latest version of XYDChatSwipeView from here:
//
//  https://github.com/nicklockwood/XYDChatSwipeView
//
...
@implementation NSObject (XYDChatSwipeView)

- (CGSize)swipeViewItemSize:(__unused XYDChatSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused XYDChatSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused XYDChatSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused XYDChatSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused XYDChatSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused XYDChatSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused XYDChatSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused XYDChatSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused XYDChatSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused XYDChatSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface XYDChatSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
@implementation XYDChatSwipeView
...
- (void)setDataSource:(id<XYDChatSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<XYDChatSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(XYDChatSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case XYDChatSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case XYDChatSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == XYDChatSwipeViewAlignmentCenter)
        {
...
{
    //get number of items
    _numberOfItems = [_dataSource numberOfItemsInXYDChatSwipeView:self];
