...
@implementation XYDRecorderProgressHud
...
+ (XYDRecorderProgressHud *)sharedView {
    static dispatch_once_t once;
    static XYDRecorderProgressHud *sharedView;
    dispatch_once(&once, ^ {
        sharedView = [[XYDRecorderProgressHud alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
...
{
    [[XYDRecorderProgressHud sharedView] setSubTitle:str];
}

+ (NSTimeInterval)seconds{
    return [[XYDRecorderProgressHud sharedView] seconds] / 10;
}
