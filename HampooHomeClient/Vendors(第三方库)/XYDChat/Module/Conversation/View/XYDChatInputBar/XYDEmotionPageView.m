...
@implementation XYDEmotionPageView
    ...
    if (self.imageViews && self.imageViews.count >= self.datas.count) {
        for (UIImageView *imageView in self.imageViews) {
            ...
            if (!imageView.hidden) {
                ...
                UIImage *faceImage = [XYDEmotionManager emotionImageWithEmotionID:[faceDict[kEmotionIDKey] integerValue]];
                imageView.tag = [faceDict[kEmotionIDKey] integerValue];
...
- (UIImageView *)faceImageViewWithID:(NSString *)faceID{
    ...
    UIImage *faceImage = [XYDEmotionManager emotionImageWithEmotionID:[faceID integerValue]];
...
- (void)handleTap:(UITapGestureRecognizer *)tap {
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectedEmotionImageWithEmotionID:)]) {
        [self.delegate selectedEmotionImageWithEmotionID:tap.view.tag];
    }
}
