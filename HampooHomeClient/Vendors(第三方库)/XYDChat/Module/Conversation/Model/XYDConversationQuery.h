...
#define XYDChatAttr(attr) ([NSString stringWithFormat:@"attr.%@", attr])

NS_ASSUME_NONNULL_BEGIN

extern NSString *const kXYDChatKeyName;
extern NSString *const kXYDChatKeyMember;
extern NSString *const kXYDChatKeyCreator;
extern NSString *const kXYDChatKeyConversationId;

@interface XYDConversationQuery : NSObject
 ...
 */
@property (nonatomic, assign) XYDChatCachePolicy cachePolicy;
...
/*!
 通过 conversationId 查询服务器，获取一个 XYDChatConversation 对象
...
/*!
 查询服务器获取一个 XYDChatConversation 对象数组
