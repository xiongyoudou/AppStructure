...
#ifdef __cplusplus
#define XYD_EXTERN_C_BEGIN  extern "C" {
#define XYD_EXTERN_C_END  }
#else
#define XYD_EXTERN_C_BEGIN
#define XYD_EXTERN_C_END
#endif
...
CGContextRef _Nullable XYDCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef _Nullable XYDCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);



/// Get main screen's scale.
CGFloat XYDScreenScale();

/// Get main screen's size. Height is always larger than width.
CGSize XYDScreenSize();
 ...
 */
CGAffineTransform XYDCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform XYDCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode XYDCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *XYDUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect XYDCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale XYDScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize XYDScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth XYDScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight XYDScreenSize().height
#endif
