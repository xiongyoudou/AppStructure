...
#import "CAAnimation+XYDEasingEquations.h"
...
+ (CAKeyframeAnimation*)xyd_transformAnimationWithDuration:(CGFloat)duration
...
+ (void)xyd_addAnimationToLayer:(CALayer *)layer
                   duration:(CGFloat)duration
                  transform:(CATransform3D)transform
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self xyd_transformAnimationWithDuration:duration
...
+ (CAKeyframeAnimation*)xyd_animationWithKeyPath:(NSString*)keyPath
                                    duration:(CGFloat)duration
...
+ (void)xyd_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    [self xyd_addAnimationToLayer:layer
                  withKeyPath:keyPath
                     duration:duration
...
+ (void)xyd_addAnimationToLayer:(CALayer *)layer
             ...
             easingFunction:(CAAnimationEasingFunction)easingFunction
{
    CAAnimation *animation = [self xyd_animationWithKeyPath:keyPath
                                               duration:duration
                                                   from:startValue
                                                     to:endValue
                                         easingFunction:easingFunction];
