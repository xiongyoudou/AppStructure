...
- (CGFloat)xyd_scoreAgainst:(NSString *)otherString fuzziness:(NSNumber *)fuzziness{
    return [self xyd_scoreAgainst:otherString fuzziness:fuzziness options:NSStringJKScoreOptionNone];
}

- (CGFloat)xyd_scoreAgainst:(NSString *)anotherString fuzziness:(NSNumber *)fuzziness options:(NSStringJKScoreOption)options{
