...
+ (void)xyd_initializeEmojiCheatCodes
{
    ...
    @synchronized(self) {
        xyd_s_unicodeToCheatCodes = forwardMap;
        xyd_s_cheatCodesToUnicode = [reversedMap copy];
    }
}

- (NSString *)xyd_stringByReplacingEmojiCheatCodesWithUnicode
{
    if (!xyd_s_cheatCodesToUnicode) {
        [NSString xyd_initializeEmojiCheatCodes];
    }
    
    if ([self rangeOfString:@":"].location != NSNotFound) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [xyd_s_cheatCodesToUnicode enumerateKeysAndObjectsUsingBlock:^(NSString *key, id obj, BOOL *stop) {
...
- (NSString *)xyd_stringByReplacingEmojiUnicodeWithCheatCodes
{
    ...
    if (self.length) {
        __block NSMutableString *newText = [NSMutableString stringWithString:self];
        [xyd_s_unicodeToCheatCodes enumerateKeysAndObjectsUsingBlock:^(id key, id obj, BOOL *stop) {
