...
@interface NSRunLoop (XYDPerformBlock)
/**
 *  @author ishkawa
 *
 ...
 */
- (void)xyd_performBlockAndWait:(void (^)(BOOL *finish))block;
/**
 *  @author ishkawa
 *
 *  @brief   extension of NSRunLoop for waiting.
 ...
 *  @param block <#block description#>
 */
- (void)xyd_performBlockAndWait:(void (^)(BOOL *finish))block timeoutInterval:(NSTimeInterval)timeoutInterval;
