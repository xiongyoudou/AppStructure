 ...
 *  @param key   被附加对象的key
 */
- (void)xyd_associateValue:(id)value withKey:(void *)key; // Strong reference
/**
 *  @brief  附加一个weak对象
 *
 *  @param value 被附加的对象
 *  @param key   被附加对象的key
 */
- (void)xyd_weaklyAssociateValue:(id)value withKey:(void *)key;
 ...
 *  @return 附加对象
 */
- (id)xyd_associatedValueForKey:(void *)key;
