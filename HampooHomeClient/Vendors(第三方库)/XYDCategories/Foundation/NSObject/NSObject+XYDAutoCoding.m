...
+ (instancetype)xyd_objectWithContentsOfFile:(NSString *)filePath
{
    //load the file
...
- (BOOL)xyd_writeToFile:(NSString *)filePath atomically:(BOOL)useAuxiliaryFile
{
...
- (NSDictionary *)xyd_codableProperties
{
    ...
    if (!codableProperties)
    {
        ...
        {
            [(NSMutableDictionary *)codableProperties addEntriesFromDictionary:[subclass xyd_codableProperties]];
...
- (NSDictionary *)xyd_dictionaryRepresentation
{
    NSMutableDictionary *dict = [NSMutableDictionary dictionary];
    for (__unsafe_unretained NSString *key in [self xyd_codableProperties])
    {
...
- (void)xyd_setWithCoder:(NSCoder *)aDecoder
{
    ...
    NSDictionary *properties = [self xyd_codableProperties];
...
{
    [self xyd_setWithCoder:aDecoder];
    return self;
}
#pragma clang diagnostic pop
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    for (NSString *key in [self xyd_codableProperties])
    {
