...
// Degree -> Rad
#define xyd_degToRad(x) (M_PI * (x) / 180.0)
...
-(void)xyd_cornerRadius: (CGFloat)radius strokeSize: (CGFloat)size color: (UIColor *)color
{
...
///////////////////////////////////////////////////////////////////////////////////////////////////
-(void)xyd_setRoundedCorners:(UIRectCorner)corners radius:(CGFloat)radius {
...
-(void)xyd_addSubview: (UIView *)subview withTransition: (UIViewAnimationTransition)transition duration: (NSTimeInterval)duration
{
	[UIView beginAnimations: nil context: NULL];
	[UIView setAnimationDuration: duration];
      ...
      timingFunction: (CAMediaTimingFunction *)timingFunction
{
    ...
    rotation.toValue = [NSNumber numberWithFloat: xyd_degToRad(angle)];
