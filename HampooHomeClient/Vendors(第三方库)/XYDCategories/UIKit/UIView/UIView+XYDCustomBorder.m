...
- (void)xyd_addTopBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xyd_addTopBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xyd_addLeftBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xyd_addLeftBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xyd_addBottomBorderWithColor:(UIColor *)color width:(CGFloat) borderWidth {
    [self xyd_addBottomBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}


- (void)xyd_addRightBorderWithColor:(UIColor *)color width:(CGFloat)borderWidth {
    [self xyd_addRightBorderWithColor:color width:borderWidth excludePoint:0 edgeType:0];
}
