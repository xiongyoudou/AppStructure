...
- (UIImage *)xyd_flip:(BOOL)isHorizontal {
...
{
    return [self xyd_imageRotatedByDegrees:[UIImage xyd_radiansToDegrees:radians]];
}
/**
 *  @brief  旋转图片
 *
...
- (UIImage *)xyd_imageRotatedByDegrees:(CGFloat)degrees
{
    ...
    CGAffineTransform t = CGAffineTransformMakeRotation([UIImage xyd_degreesToRadians:degrees]);
    ...
    CGContextRotateCTM(bitmap, [UIImage xyd_degreesToRadians:degrees]);
