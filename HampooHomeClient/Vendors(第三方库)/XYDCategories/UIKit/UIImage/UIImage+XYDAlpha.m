 ...
 */
- (UIImage *)xyd_imageWithAlpha {
    if ([self xyd_hasAlpha]) {
        return self;
    }
 ...
 *  @return 增加透明边框后的图片
 */
- (UIImage *)xyd_transparentBorderImage:(NSUInteger)borderSize {
    ...
    CGImageRef maskImageRef = [self xyd_newBorderMask:borderSize size:newRect.size];
