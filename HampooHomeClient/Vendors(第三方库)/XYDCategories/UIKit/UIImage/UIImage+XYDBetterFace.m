...
{
    NSArray *features = [UIImage _xyd_faceFeaturesInImage:self accuracy:accurary];
    ...
    if ([features count]==0) {
        ...
        return [self _xyd_subImageForFaceFeatures:features
                                         size:size];
    }
}

- (UIImage *)_xyd_subImageForFaceFeatures:(NSArray *)faceFeatures size:(CGSize)size
{
...
+ (NSArray *)_xyd_faceFeaturesInImage:(UIImage *)image accuracy:(JKAccuracy)accurary
{
