...
*/
+ (UIImage *)xyd_animatedImageWithAnimatedGIFData:(NSData *)theData;

/*
        UIImage *image = [UIImagexyd_ animatedImageWithAnimatedGIFURL:theURL];
...
*/
+ (UIImage *)xyd_animatedImageWithAnimatedGIFURL:(NSURL *)theURL;
