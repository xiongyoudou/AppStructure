...
- (UIImage *)xyd_thumbnailImage:(NSInteger)thumbnailSize
       ...
       interpolationQuality:(CGInterpolationQuality)quality {
    UIImage *resizedImage = [self xyd_resizedImageWithContentMode:UIViewContentModeScaleAspectFill
    ...
    CGRect cropRect = CGRectMake(round((resizedImage.size.width - thumbnailSize) / 2),
                                 ...
                                 thumbnailSize,
                                 thumbnailSize);
    UIImage *croppedImage = [resizedImage xyd_croppedImage:cropRect];
    
    UIImage *transparentBorderImage = borderSize ? [croppedImage xyd_transparentBorderImage:borderSize] : croppedImage;

    return [transparentBorderImage xyd_roundedCornerImage:cornerRadius borderSize:borderSize];
}

// Returns a rescaled copy of the image, taking into account its orientation
// The image will be scaled disproportionately if necessary to fit the bounds specified by the parameter
- (UIImage *)xyd_resizedImage:(CGSize)newSize interpolationQuality:(CGInterpolationQuality)quality {
    BOOL drawTransposed;
    ...
    return [self xyd_resizedImage:newSize
                    transform:[self xyd_transformForOrientation:newSize]
