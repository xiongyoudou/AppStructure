...
@implementation UIImage (XYDBlur)
#pragma mark -
#pragma mark - Effects
...
- (UIImage *)xyd_lightImage
{
    ...
    return [self xyd_blurredImageWithSize:CGSizeMake(60, 60) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)xyd_extraLightImage
{
    ...
    return [self xyd_blurredImageWithSize:CGSizeMake(40, 40) tintColor:tintColor saturationDeltaFactor:1.8 maskImage:nil];
}
...
- (UIImage *)xyd_tintedImageWithColor:(UIColor *)tintColor
{
    ...
    return [self xyd_blurredImageWithSize:CGSizeMake(20, 20) tintColor:effectColor saturationDeltaFactor:-1.0 maskImage:nil];
}
...
{
    return [self xyd_blurredImageWithSize:CGSizeMake(blurRadius, blurRadius)];
}
...
{
    return [self xyd_blurredImageWithSize:blurSize tintColor:nil saturationDeltaFactor:1.0 maskImage:nil];
}
...
//| ----------------------------------------------------------------------------
- (UIImage *)xyd_blurredImageWithSize:(CGSize)blurSize tintColor:(UIColor *)tintColor saturationDeltaFactor:(CGFloat)saturationDeltaFactor maskImage:(UIImage *)maskImage
{
...
#define ENABLE_TINT                     1
    ...
    if (hasBlur || hasSaturationChange)
    {
        ...
        if (hasBlur)
        {
            CGFloat radiusX = [self xyd_gaussianBlurRadiusWithBlurRadius:blurSize.width * inputImageScale];
            CGFloat radiusY = [self xyd_gaussianBlurRadiusWithBlurRadius:blurSize.height * inputImageScale];
        ...
        if ( (effectCGImage = vImageCreateCGImageFromBuffer(inputBuffer, &format, &xyd_cleanupBuffer, NULL, kvImageNoAllocate, NULL)) == NULL ) {
...
//
- (CGFloat)xyd_gaussianBlurRadiusWithBlurRadius:(CGFloat)blurRadius
{
...
//
void xyd_cleanupBuffer(void *userData, void *buf_data)
{ free(buf_data); }
