...
// it is ignored.
// =====================================================
- (void)xyd_adjustLabelToMaximumSize:(CGSize)maxSize
...
- (void)xyd_adjustLabelToMaximumSize:(CGSize)maxSize
                 minimumFontSize:(int)minFontSize
{
  [self xyd_adjustLabelToMaximumSize:maxSize
...
// =====================================================
- (void)xyd_adjustLabelSizeWithMinimumFontSize:(int)minFontSize
{
  [self xyd_adjustLabelToMaximumSize:CGSizeZero
                     minimumSize:CGSizeZero 
                 minimumFontSize:minFontSize];
}
