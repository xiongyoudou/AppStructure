...
- (UILabel *)xyd_resizeLabelVertical{
    return [self xyd_resizeLabelVertical:0];
}

- (UILabel *)xyd_resizeLabelVertical:(CGFloat)minimumHeigh{
...
- (UILabel *)xyd_resizeLabelHorizontal:(CGFloat)minimumWidth{
    CGRect newFrame = self.frame;
