...
+(UIFont *)xyd_preferredFontForTextStyle:(NSString *)style withFontName:(NSString *)fontName{
    return [UIFont xyd_preferredFontForTextStyle:style withFontName:fontName scale:1.0f];
}
...
+(UIFont *)xyd_preferredFontForTextStyle:(NSString *)style withFontName:(NSString *)fontName scale:(CGFloat)scale{
    ...
    return [font xyd_adjustFontForTextStyle:style];

}

-(UIFont *)xyd_adjustFontForTextStyle:(NSString *)style{
    return [self xyd_adjustFontForTextStyle:style scale:1.0f];
}

-(UIFont *)xyd_adjustFontForTextStyle:(NSString *)style scale:(CGFloat)scale{
