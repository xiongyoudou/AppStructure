...
- (CGRect)xyd_convertRectFromImage:(CGRect)imageRect {
    ...
    CGPoint viewTopLeft     = [self xyd_convertPointFromImage:imageTopLeft];
    CGPoint viewBottomRight = [self xyd_convertPointFromImage:imageBottomRight];
...
- (CGRect)xyd_convertRectFromView:(CGRect)viewRect {
    ...
    CGPoint imageTopLeft = [self xyd_convertPointFromView:viewTopLeft];
    CGPoint imageBottomRight = [self xyd_convertPointFromView:viewBottomRight];
