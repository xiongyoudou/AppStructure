...
+ (NSString *)xyd_platformString{
    NSString *platform = [self xyd_platform];
...
+ (NSUInteger)xyd_getSysInfo:(uint)typeSpecifier
{
...
+ (NSUInteger)xyd_cpuFrequency {
    return [self xyd_getSysInfo:HW_CPU_FREQ];
}

+ (NSUInteger)xyd_busFrequency {
    return [self xyd_getSysInfo:HW_BUS_FREQ];
}

+ (NSUInteger)xyd_ramSize {
    return [self xyd_getSysInfo:HW_MEMSIZE];
}

+ (NSUInteger)xyd_cpuNumber {
    return [self xyd_getSysInfo:HW_NCPU];
}


+ (NSUInteger)xyd_totalMemoryBytes
{
    return [self xyd_getSysInfo:HW_PHYSMEM];
}
