...
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    TLPictureMetadata *meta = _large ? _large : _largest ? _largest : _original;
    _badgeType = meta.badgeType;
    return YES;
}
@end

@implementation TLURL
+ (NSDictionary *)modelCustomPropertyMapper {
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"picIds" : [NSString class],
             @"picInfos" : [TLPicture class],
             @"urlStruct" : [TLURL class],
             @"topicStruct" : [TLTopic class],
             @"tagStruct" : [TLTag class]};
}
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    // 自动 model-mapper 不能完成的，这里可以进行额外处理
    _pics = nil;
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"statuses" : [TLModel class]};
}
@end

@implementation TLEmoticon
+ (NSArray *)modelPropertyBlacklist {
    return @[@"group"];
}
@end

@implementation TLEmoticonGroup
+ (NSDictionary *)modelCustomPropertyMapper {
    return @{@"groupID" : @"id",
...
+ (NSDictionary *)modelContainerPropertyGenericClass {
    return @{@"emoticons" : [TLEmoticon class]};
}
- (BOOL)modelCustomTransformFromDictionary:(NSDictionary *)dic {
    [_emoticons enumerateObjectsUsingBlock:^(TLEmoticon *emoticon, NSUInteger idx, BOOL *stop) {
        emoticon.group = self;
    }];
    return YES;
}
